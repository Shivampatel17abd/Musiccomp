      ...
      /> 
        ...
        <div className="p-4 z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into our comprehensive Music courses and 
                transform your musical journney today. Whether you're
               beginner or looking for refine  your skills. join us to unlock your true potential.
               </p>
               <div className="mt-4">
                <Link href={"/courses"}
